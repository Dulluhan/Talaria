...
%% Motor Model 
function [omega_w,torque_m] = motor_obj(T_m)
    %Input: T_m which is required toque generated by change in acceleration
    %of motor. 
    global m_w;
    global dt;
    alpha = (T_m/m_w); %angular acceleration needed 
    omega_w = alpha*dt;
...
% Animation 
    ...
    delete([pend,ball,O_circ,pend2,ball2]);
